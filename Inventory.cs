...
namespace virtVendingMachine
{
    public class Inventory
    {
        ...
        public string GetItem(string selector, decimal balance)
        {
            ...
            {
                message.Append(string.Format("Exception thrown: {0}", x.ToString()));
                return message.ToString();
            }
        }
